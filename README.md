...
# 破解二进制文件下载地址：[release](https://github.com/xiaoanweiwu/crack-soga-v2ray/releases)
...
``` bash
sudo bash < <(curl -Ls https://raw.githubusercontent.com/xiaoanweiwu/crack-soga-v2ray/master/install.sh)
```
